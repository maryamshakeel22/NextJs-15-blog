...
export default function Blog() {
  return (
    <div className="justify-center text-center items-center whitespace-nowrape w-full">
    <div className="p-4">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">Exploring Next.js 15 RC</h1>
        <p className="text-lg md:text-2xl mb-6">
        Discover the latest features in Next.js 15 RC, including updates in development, production, and caching for a smoother experience.
        </p>
    ...
    <div className="p-4">
        ...
        <ul className="flex flex-wrap justify-center gap-4 mb-6 ">
            <li className='bg-slate-100 px-4 py-2 rounded'>Support for React 19 RC</li>
            <li className='bg-slate-100 px-4 py-2 rounded'>Hydration error improvements</li>
            <li className='bg-slate-100 px-4 py-2 rounded'>Caching improvements</li>
            <li className='bg-slate-100 px-4 py-2 rounded'>Updated create-next-app</li>
            <li className='bg-slate-100 px-4 py-2 rounded'>Bundling external packages</li>
            <li className='bg-slate-100 px-4 py-2 rounded'>Experimental features</li>
            <li className='bg-slate-100 px-4 py-2 rounded'>React compiler</li>
            <li className='bg-slate-100 px-4 py-2 rounded'>Partial prerendering</li>
            <li className='bg-slate-100 px-4 py-2 rounded'>Next/After</li>
        </ul>
...
The <code>–turbo</code> flag can be used to activate Turbopack.
    ...
    <Link href="/">
    <button className='bg-slate-800 mt-5 mb-5 text-white hover:bg-slate-500 pt-3 pb-3 pr-3 pl-3 rounded'>Back to Home</button>
    </Link>
</div>
  )
}
